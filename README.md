...
Download python script created by **aul12** from github repo: 
```console
git clone https://github.com/aul12/CubeMxCMake.git
```

Enter to downloaded repo directory and create CMakeList.txt file 
```console
cd CubeMxCMake/
python3 cubeMxCMake.py CMakeTemplate.txt [pathForYourInputProjectFile.ioc] [pathForOutputCmakeFile/CMakeLists.txt]
```

In this step I've got problem mention in this issue: https://github.com/aul12/CubeMxCMake/issues/1. Fix#1 branch helpd me :)

But when I tried to to rn cmake I had next problemm:
```console
CMake Error at CMakeLists.txt:45 (add_executable):
  Cannot find source file:

    /media/macias/data/projects/source/C++/NucleoF411RE/NucleoF411RE/STM32F4_FLASH.ld
```
File is created correctply only at firt start. So I recommend to change his name from *STM32F411RETx_FLASH.ld* in my case to *STM32F4_FLASH.ld* which is included in created CMakeLists.txt file

### Modify CMakeLists.txt file generated by script to make it compile correct:
 - add full path for arm-none-eabi-* file:
 ```cmake
...
set(AS /home/macias/opt/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-9.2.1-1.1/bin/arm-none-eabi-as)
set(AR /home/macias/opt/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-9.2.1-1.1/bin/arm-none-eabi-ar)
set(OBJCOPY /home/macias/opt/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-9.2.1-1.1/bin/arm-none-eabi-objcopy)
set(OBJDUMP /home/macias/opt/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-9.2.1-1.1/bin/arm-none-eabi-objdump)
set(SIZE /home/macias/opt/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-9.2.1-1.1/bin/arm-none-eabi-size)
 ```
 
 - add define for your target ad the and of `add_definitions`:
 ```
 add_definitions(-DSTM32F411xE )
 ```
 - correct a BUG in generating CMake file, by replacin in last step **add_custom_command** using of **CMAKE_OBJCOPY** to **OBJCOPY**
 ```cmake
...
### Compile code from command line
